...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_buttonTest) {
            // Handle the camera action
         /* fragmentManager.beginTransaction().replace(R.id.content_frame,new ButtonsTest()).commit();*/
        } else if (id == R.id.nav_myProfile) {

        } else if (id == R.id.nav_moveFile) {

        } else if (id == R.id.nav_fetchContact) {
